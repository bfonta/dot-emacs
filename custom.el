...
(custom-set-variables
 ...
 '(package-selected-packages
   '(bash-completion benchmark-init cern-ldap company-auctex
					 company-c-headers company-fuzzy company-quickhelp
					 dired-collapse dired-rainbow dired-sidebar
					 disk-usage exec-path-from-shell expand-region flx
					 flycheck git-link git-timemachine go-mode gptel
					 grep-a-lot helm-bibtex helm-cscope imenu-list
					 impatient-mode magit markdown-mode openwith
					 org-ref org-roam pdf-tools projectile pulsar
					 python-mode pyvenv quelpa-use-package
					 rainbow-delimiters restart-emacs shackle slime
					 smooth-scrolling sudo-edit vi-tilde-fringe vundo
					 webpaste wttrin zenburn-theme)))
