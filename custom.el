(custom-set-variables
 ...
 '(package-selected-packages
   '(ag all-the-icons anaphora bash-completion benchmark-init cdlatex
		company-auctex company-box company-c-headers company-fuzzy
		company-jedi company-quickhelp conda copilot dap-mode
		dired-collapse dired-rainbow dired-sidebar disk-usage ebib
		editorconfig emacsql-mysql emacsql-sqlite
		emacsql-sqlite-builtin emacsql-sqlite-module emojify ess
		exec-path-from-shell expand-region flx flycheck git git-link
		gnuplot go-complete gptel grep-a-lot helm-bibtex helm-lsp
		helm-slime helm-swoop hide-mode-line highlight-indentation
		imenu-list impatient-mode irony jedi json-rpc
		latex-math-preview lsp-ui multiple-cursors nlinum notmuch
		openwith org-ref org-roam ov pdf-tools php-mode pkg-info
		polymode pulsar python-mode pyvenv quelpa quelpa-use-package
		rainbow-delimiters realgud restart-emacs shackle
		slime-repl-ansi-color smooth-scrolling sudo-edit swiper-helm
		toc-org use-package vi-tilde-fringe vterm-toggle vundo
		webpaste websocket which-key with-venv wttrin yaml-mode
