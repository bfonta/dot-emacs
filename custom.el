(custom-set-variables
 ...
 '(package-selected-packages
   '(tree-sitter editorconfig copilot quelpa-use-package quelpa go-complete readline-complete org-noter-pdftools helm-bibtex toc-org ggtags openwith dired-collapse dired dired-rainbow with-venv vterm-toggle orglink imenu-list restart-emacs company-jedi tex company-auctex tex-ispell cl latex nlinum shackle latex-math-preview epc git pdf-continuous-scroll-mode org-pdftools yasnippet-classic-snippets native-complete ssh org-download visual-fill-column org-superstar exwm rainbow-delimiters spacemacs-theme hide-mode-line easy-after-load minions ghub mu4e-alert smtpmail-multi company-c-headers smooth-scrolling helm-pydoc pydoc anaconda-mode magithub eimp image+ go-mode neotree smartparens latex-preview-pane yaml-mode latex-unicode-math-mode yasnippet))
