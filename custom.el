(custom-set-variables
 ...
 '(package-selected-packages
   '(pdf-tools zoom zenburn-theme yasnippet-snippets yasnippet-classic-snippets yaml-mode xterm-color with-venv which-key webpaste vundo vterm-toggle vi-tilde-fringe use-package toc-org tablist swiper-helm stripes smooth-scrolling slime-repl-ansi-color shackle restart-emacs realgud rainbow-delimiters quelpa pyvenv python-mode pulsar php-mode ov orglink org-roam org-ref openwith nlinum multiple-cursors magit lsp-ui latex-math-preview julia-mode jedi irony impatient-mode imenu-list highlight-indentation hide-mode-line helm-swoop helm-slime helm-lsp helm-bibtex go-complete gnuplot git-timemachine git-link git-auto-commit-mode git flycheck flx expand-region exec-path-from-shell ess emojify ein ebib dired-sidebar dired-rainbow dired-collapse dap-mode csv-mode conda company-quickhelp company-jedi company-fuzzy company-c-headers company-box company-auctex cdlatex benchmark-init bash-completion all-the-icons ag)))
...
(custom-set-faces
 ...
 '(org-ellipsis ((t (:inherit default :weight regular :foreground "#DCDCCC" :spacing 0.2 :family "Sans Serif" :foreground "#989890"))))
 '(org-level-1 ((t (:inherit default :weight regular :foreground "#DCDCCC" :spacing 0.2 :family "Sans Serif" :foreground "#6C3333"))))
 '(org-level-2 ((t (:inherit default :weight regular :foreground "#DCDCCC" :spacing 0.2 :family "Sans Serif" :foreground "#7F9F7F"))))
 '(org-level-3 ((t (:inherit default :weight regular :foreground "#DCDCCC" :spacing 0.2 :family "Sans Serif" :foreground "#6a5acd"))))
 '(org-level-4 ((t (:inherit default :weight regular :foreground "#DCDCCC" :spacing 0.2 :family "Sans Serif" :foreground "#DEB887"))))
 '(org-level-5 ((t (:inherit default :weight regular :foreground "#DCDCCC" :spacing 0.2 :family "Sans Serif" :foreground "#BA55D3"))))
 '(org-level-6 ((t (:inherit default :weight regular :foreground "#DCDCCC" :spacing 0.2 :family "Sans Serif" :foreground "#5C4033"))))
