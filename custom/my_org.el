...
(use-package org
  ...
  (defun my/style-org ()
	...
	(custom-theme-set-faces 'user
							...
							`(org-level-4 ((t (:height 1.00 :foreground "#93E0E3"))))
							`(org-level-5 ((t (:height 1.00 :foreground "#DFAF8F"))))
							`(org-level-6 ((t (:height 1.00 :foreground "#DFAF8F"))))
							`(org-level-7 ((t (:height 1.00 :foreground "#DFAF8F"))))
							`(org-level-8 ((t (:height 1.00 :foreground "#DFAF8F"))))
