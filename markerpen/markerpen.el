...
(global-set-key (kbd "C-p") 'markerpen-mark-region) ; Use this to apply a markerpen
(global-set-key (kbd "C-S-p") 'markerpen-clear-all-marks)

(defconst markerpens '())

;; Background colour marker pens - these can be used nicely together with font-lock
(defconst markerpen-initial-pen-colours '("tomato4" ; markerpen1
					  "gray24"   ; markerpen2
					  "gold4"    ; markerpen3
					  "navy"     ; markerpen4
					  ))
...
(defface markerpen-face-c '((t :height 1.1 :inherit variable-pitch)) "MarkerPen")
